...
public class BookDaoMock implements BookDao {
	...
	public BookDaoMock() {
		...
		Book book1 = new Book();
		book1.setId(1);
		book1.setName("Wodecki. Tak mi wyszło");
		book1.setAuthor("Bałuk Kamil, Krupiński Wacław");
		...
		Book book3 = new Book();
		book3.setId(3);
		book3.setName("Czerwone krzesło. Magiczne drzewo. Tom 1");
		...
		book4.setAuthor("Piątkowska Renata");
		...
		Book book5 = new Book();
		book5.setId(5);
		book5.setName("Fantastyczne zwierzęta i jak je znaleźć. Leksykon");
		...
		Book book6 = new Book();
		book6.setId(6);
		book6.setName("Księniczka Popiołu");
		...
		Book book7 = new Book();
		book7.setId(7);
		book7.setName("Wiedźmin. Tom 1. Ostatnie życzenie");
		...
		book12.setId(12);
		book12.setName("Kajko i Kokosz. Szkoła latania.");
		...
		book14.setId(14);
		book14.setName("Czarownice nie płoną");
	...
	public Book selectById(Integer id) {
		...
		throw new RuntimeException("Brak książki o id: " + id);
	}
	...
	public void deleteById(Integer id) {
		System.out.println(" ");
		System.out.println("USUWANIE DANYCH O KSIĄŻCE");
		System.out.println(" ");
		...
		if (hasBookBeenFound) {
			System.out.println("Dane o książce o id " + id + " zostały usunięte...");
		} else {
			System.out.println("W bazie danych nie ma książki o id: " + id);
		}
